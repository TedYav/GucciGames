...
public interface GameEngineToActualGame {
	...
	public ATargetCoordinate getValidLocations(GameUnit actingUnit, String actionType);
	 ...
	 */
	public void performAction(GameUnit actingUnit, IMapObjectAction actionType) throws AbilityException;
	 ...
	 * 	 */
	public void performAction(GameUnit actingUnit, IMapObjectAction actionType, ATargetCoordinate actionTarget) throws AbilityException;
