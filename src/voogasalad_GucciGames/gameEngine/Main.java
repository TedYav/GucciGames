...
public class Main {
	...
	/*
	 * public static void main(String[] args) { // test conditions:
	 * GamePlayerPerson p0 = new GamePlayerPerson(0); GamePlayerPerson p = new
	 * GamePlayerPerson(-1); // Map<String, List<Integer>>
	 * dummyCharacteristicMap = new TreeMap<>(); // List<Integer> temp = new
	 * ArrayList<Integer>(); // temp.add(1); // temp.add(3); //
	 * dummyCharacteristicMap.put("MovableCharacteristic", temp);
	 * 
	 * Map<Integer, GamePlayerPerson> map = new HashMap<Integer,
	 * GamePlayerPerson>();
	 * 
	 * map.put(-1, p); map.put(0, p0);
	 * 
	 * 
	 * AllPlayers allPlayers = new AllPlayers(map); GameLevelEngine engine = new
	 * GameLevelEngine(allPlayers); engine.createTestCondition();
	 * 
	 * MovableCharacteristic myMovableCharacteristic = new
	 * MovableCharacteristic(1, 3); HealthCharacteristic myHealthCharacteristic
	 * = new HealthCharacteristic(5);
	 * 
	 * MapObject soldier = new MapObject("soldier", "./../");
	 * 
	 * MapObject sold1 = new MapObject(soldier, new TargetCoordinateSingle(0,
	 * 0),0);
	 * 
	 ...
	 * //WhereToMoveEvent myMoveLocationEvent = new
	 * WhereToMoveEvent("WhereToMove");
	 * 
	 * sold1.addCharacteristic("MovableCharacteristic",
	 * myMovableCharacteristic); sold1.addCharacteristic("HealthCharacteristic",
	 * myHealthCharacteristic); soldier.addEvent("Move", myMoveEvent);
	 * //soldier.addRequest("WhereToMove", myMoveLocationEvent);
	 * 
	 * 
	 * // engine.getPossibleCoordinates("Move", (PlayerMapObjectInterface)
	 * sold1);
	 * 
	 * 
	 * //engine.endTurn();
