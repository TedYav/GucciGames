...
public class GameMenuBar {
	...
	/**
	 * Takes a list of menu objects, implementing Menu interface Instantiates
	 * each of them with JavaFX
	 * 
	 * @param menus
	 */
	private ToolBar menu;
	private ResourceBundle myBundle = ResourceBundle
			.getBundle("voogasalad_GucciGames.gameplayer.config.menubar.menubar");
	private ResourceBundle myCssBundle = ResourceBundle
			.getBundle("voogasalad_GucciGames.gameplayer.config.scenes.CssClasses");
