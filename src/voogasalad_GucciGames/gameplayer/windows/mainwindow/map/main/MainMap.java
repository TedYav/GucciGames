...
//		
	...
	private void addToMap(PlayerMapObjectInterface object) {
		...
		if(!myCellMap.containsKey(key)){
			...
			myMap.add(newCell.getParent(), (int) (((TargetCoordinateSingle)object).getCenterX()), (int) (((TargetCoordinateSingle)object).getCenterY()));
		}
	...
	public void highlightCells(List<ATargetCoordinate> targets) {
		targets.stream()
			.map((t) -> new Point2D(((TargetCoordinateSingle) t).getCenterX(), ((TargetCoordinateSingle) t).getCenterY()))
