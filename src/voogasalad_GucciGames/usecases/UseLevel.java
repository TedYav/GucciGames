...
public class UseLevel {
	...
	// when user makes a level, everything and nothing changes I guess. Omg this
	// is annoyingly complicated

	// should use same game authoring environment, but you'll need a new
	// gameengine because why?
	// can be same tbh, you'll want different list of players and such though.
	...
	public void setCondition(Outcome outcome) {
		...
		// this should be done through an outcome, so when the game is checking
		// outcomes
		// if a certain outcome is fulfilled, the game switches to a different
		// scene
	}

	public void checkTransferable() {
		// rolls through all map objects and if they have transferable
		// characteristic, they're copied into the new level
	...
	public Scene createNewLevel() {
		...
		return levelScene;
		// this creates a new level, which returns a scene that the user can go
		// to.
	}

	public void setTranserable() {
		// when user is creating game, if he/she wants something to be
		// transferable, give it the transferable characteristic
