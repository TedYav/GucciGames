...
public class UseGoal {
	...
	public void addRequirement(List<String> names, List<Double> values) {
		// this method is called every time a user enters a condition for a
		// goal.
		// this method will populate requirements map with the name of the
		// variables
		// and their target value to achieve a goal.
		// the key of the map will be the condition id, which will increments
		// after each
	...
	public void checkSatisfied() {
		// this method will loop over the map of conditions required to achieve
		// a goal
