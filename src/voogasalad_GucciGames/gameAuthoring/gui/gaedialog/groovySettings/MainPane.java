...
public class MainPane extends GridPane {
	...
	public MainPane(ISwitchSettingsPane settingsPaneController, Properties prop, IDialogGaeController dialogController,
			MapObjectType type, ActionParamsValue actionParamsValue, List<ObjParamValue> objParamValue) {
	...
	private void addActionForGroovyNextBtn() {
		...
		nextBtn.setOnAction(e -> {
			...
			groovyPaneController.switchGroovyPane(
					Reflection.createInstance(name, selected, groovyPaneController, dialogController),
					"Custom " + selected);
		});
