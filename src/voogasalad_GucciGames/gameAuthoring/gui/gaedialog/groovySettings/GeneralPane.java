...
public class GeneralPane extends GridPane {
	...
	public GeneralPane(List<String> attributes, GroovyType groovyType, ISwitchGroovyPane controller,
			IDialogGaeController gaeController, IDependencies addDepController, String name) {
	...
	protected void init(List<String> items, String name, String title) {
		...
		nextBtn.setOnAction(e -> {
			...
			controller.switchGroovyPane(reflection.createInstance(path + "DependenciesPane", items, gaeController,
					addDepController, this.groovyType, name), title);
