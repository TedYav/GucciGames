...
public class PlayerCharDialog2 extends AGaeDialog<ObjParamValue>{
	private ObjParamListPane objParamListPane;
	private IDialogGaeController controller;
	private int playerid;
	
	public PlayerCharDialog2(List<ObjParam> param, IDialogGaeController controller, int playerid){
		super();
